...
import { createVideo, resolveTagNamesToIds, type ApiError } from "@/lib/api";
...
export default function NewVideoPage() {
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      const { data, error: err } = await createVideo(token, {
        title,
        youtubeUrl,
  ...
  return (
    <div>
      ...
      <h1 className="mb-6 text-2xl font-semibold text-stone-900">Add video</h1>
